...
platform driver. The system will then call the registered probe and remove
functions when required, shown in Algorithms~\ref{func:probe}
...
called. This caches the current state of the gamepad buttons, which can be read
by calling $read()$ on the character device.
